...
export async function POST(request: Request) {
  ...
  if (payload.modelVersion !== CANDIDATE_MODEL_VERSION || payload.validationStatus !== "PROVISIONAL_BACKTEST" || !payload.survivorshipBias || !payload.generatedAt || !payload.markets) return jsonError("Invalid provisional v2.1 backtest artifact", 400);
