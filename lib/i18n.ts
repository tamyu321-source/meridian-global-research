...
const zhTW: Record<CopyKey,string> = {
  ...
  settingsEyebrow:"僅限擁有者／設定",baseCurrency:"基準貨幣",paperCapital:"模擬資金",email:"電子郵件",enableEmail:"透過 Resend 啟用 Email 提醒",saved:"已儲存",saveFailed:"儲存失敗",inAppEmailDelivered:"站內與 Email 通知均已送達",inAppDelivered:"站內通知已送達；Email 尚未設定",alertFailed:"通知傳送失敗",
...
const ja: Record<CopyKey,string> = {
  ...
  settingsEyebrow:"所有者専用／設定",baseCurrency:"基準通貨",paperCapital:"模擬資金",email:"メール",enableEmail:"Resendでメール通知を有効化",saved:"保存しました",saveFailed:"保存失敗",inAppEmailDelivered:"アプリ内・メール通知を送信しました",inAppDelivered:"アプリ内通知を送信。メール未設定",alertFailed:"通知失敗",
  errorGeneric:"処理を完了できませんでした。再試行してください。",errorSignIn:"ログインが必要です。",errorService:"模擬ポートフォリオは一時的に利用できません。",errorInvalidOrder:"有効な銘柄、売買、整数数量を入力してください。",errorSetup:"先に模擬ポートフォリオを設定してください。",errorNoQuote:"この銘柄の現在値を取得できません。",errorMarketQuantity:"数量がこの市場の取引単位に適合しません。",errorStaleQuote:"価格が古いため模擬約定できません。",errorDrawdown:"ドローダウンが{max}%の停止線に達し、新規買いを停止しました。",errorT1:"売却数量が現在売却可能なA株数量を超えています（T+1）。",errorPosition:"この注文は「{plan}」プランの1銘柄上限{max}%を超えます。",errorMarket:"この注文は市場上限{max}%を超えます。",errorSector:"この注文はセクター上限{max}%を超えます。",errorCash:"為替と取引費用を含めると模擬現金が不足します。",errorPortfolio:"模擬ポートフォリオを取得できません。",errorOrder:"模擬注文を完了できませんでした。",
};
...
const ko: Record<CopyKey,string> = {
  ...
  settingsEyebrow:"소유자 전용／설정",baseCurrency:"기준 통화",paperCapital:"모의 자금",email:"이메일",enableEmail:"Resend 이메일 알림 활성화",saved:"저장됨",saveFailed:"저장 실패",inAppEmailDelivered:"앱 및 이메일 알림 전송 완료",inAppDelivered:"앱 알림 전송 완료; 이메일 미설정",alertFailed:"알림 실패",
